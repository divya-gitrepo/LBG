...
import com.example.presentation.navigation.NavigationLBG
import com.example.presentation.ui.screens.components.ListItem
            ...
            LazyColumn {
                items(it){ item->
                    ListItem(item){ product->
                        onClick(
                            NavigationLBG.ProductDetailsScreen.route + "/{$TITLE_STRING}"
